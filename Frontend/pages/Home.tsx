                                    ...
                                    <div key={idx} className="bg-white rounded-3xl border border-[#E6E6E6] shadow-md hover:shadow-xl transition-all duration-300 relative overflow-hidden group">
                                        ...
                                        <div className="p-6 md:p-8 flex flex-col md:flex-row gap-8">
                                            ...
                                            <div className="flex-grow">
                                                <h3 className="text-2xl md:text-3xl font-black text-[#2E7D32] mb-5 tracking-tight flex items-center gap-3">
                                                    <span className="w-10 h-10 rounded-full bg-[#E8F5E9] text-[#1B5E20] flex items-center justify-center text-lg shadow-inner border border-green-100">
                                                        {idx + 1}
                                                    </span>
                                                    {year.year}: {year.goal}
                                                </h3>
                                            ...
                                            <div className="md:w-72 flex-shrink-0 flex flex-col justify-center gap-4 border-t md:border-t-0 md:border-l border-gray-100 pt-6 md:pt-0 md:pl-8">
                                                ...
                                                {btnConfig && (
                                                    <button
                                                        ...
                                                        className="w-full flex flex-col items-center justify-center gap-3 p-8 md:p-10 bg-[#1B5E20] hover:bg-[#2E7D32] text-white rounded-[32px] transition-all shadow-lg hover:shadow-xl active:scale-[0.98] group/btn min-h-[220px]"
                                                    >
                                                        <div className="p-3 bg-white/10 rounded-2xl mb-1 flex items-center justify-center">
                                                            {btnConfig.icon}
                                                        </div>
                                                        <span className="font-black text-xl md:text-2xl uppercase tracking-widest text-center leading-tight">{btnConfig.label}</span>
                                                        <span className="text-sm md:text-base font-medium text-white/90 text-center leading-snug">{btnConfig.description}</span>
